...
var G__18279 = o;
(G__18279[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__18280__delegate = function (args){
...
while (G__18281__i < G__18281__a.length) {G__18281__a[G__18281__i] = arguments[G__18281__i + 0]; ++G__18281__i;}
  args = new cljs.core.IndexedSeq(G__18281__a,0);
} 
return G__18280__delegate.call(this,args);};
...
return G__18280__delegate(args);
});
...
var old_18283 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_18283))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_18283)].join(''):class$));
} else {
}
...
var G__18286 = jsprops;
(G__18286["defaultValue"] = value);

(G__18286["onChange"] = ((function (G__18286,v,value,on_change){
return (function (p1__18284_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__18284_SHARP_);
});})(G__18286,v,value,on_change))
);
...
var vec__18288 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__18288,(0),null);
var id = cljs.core.nth.call(null,vec__18288,(1),null);
var class$ = cljs.core.nth.call(null,vec__18288,(2),null);
...
var temp__4427__auto__ = (function (){var G__18290 = cljs.core.meta.call(null,v);
var G__18290__$1 = (((G__18290 == null))?null:reagent.impl.template.get_key.call(null,G__18290));
return G__18290__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__18292_18293 = v;
var G__18292_18294__$1 = (((G__18292_18293 == null))?null:reagent.impl.template.key_from_vec.call(null,G__18292_18293));
var G__18292_18295__$2 = (((G__18292_18294__$1 == null))?null:(jsprops["key"] = G__18292_18294__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__18298 = cljs.core.meta.call(null,argv);
var G__18298__$1 = (((G__18298 == null))?null:reagent.impl.template.get_key.call(null,G__18298));
return G__18298__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__18299 = (((jsprops == null))?{}:jsprops);
(G__18299["key"] = key);
...
var n__17729__auto___18300 = a.length;
var i_18301 = (0);
while(true){
if((i_18301 < n__17729__auto___18300)){
(a[i_18301] = reagent.impl.template.as_element.call(null,(a[i_18301])));

var G__18302 = (i_18301 + (1));
i_18301 = G__18302;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__17729__auto___18303 = a.length;
var i_18304 = (0);
while(true){
if((i_18304 < n__17729__auto___18303)){
var val_18305 = (a[i_18304]);
if((cljs.core.vector_QMARK_.call(null,val_18305)) && ((reagent.impl.template.key_from_vec.call(null,val_18305) == null))){
(o["no-key"] = true);
} else {
}

(a[i_18304] = reagent.impl.template.as_element.call(null,val_18305));
...
var G__18308 = (cljs.core.count.call(null,argv) - first_child);
switch (G__18308) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__18308){
...
//# sourceMappingURL=template.js.map?rel=1450218777679